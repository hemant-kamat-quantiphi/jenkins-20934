pipeline {
  ...
  stage('Deploy') { // Run pylint against your code
     steps {
        script {
         sh """
          sudo scp -i /home/ec2-user/hemant_kamat.pem -o StrictHostKeyChecking=no -r /var/lib/jenkins/workspace/20934-jenkins ec2-54-167-215-55.compute-1.amazonaws.com:~
